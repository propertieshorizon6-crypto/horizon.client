...
const TourCard = memo(({ tour }) => {
  ...
  const { property, status, visitType, date, time, agent } = tour;
    ...
    <>
      <div className={`bg-white rounded-2xl border overflow-hidden shadow-md transition-all ${
        ...
        {isCancelled ? (
          ...
          <div className="mx-5 mb-5 px-4 py-3 bg-amber-50 border border-amber-100 rounded-xl flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center">
              <svg
